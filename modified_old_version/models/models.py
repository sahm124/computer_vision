...
class MultiLayerFastLocalGraphModelV2(object):
    ...
    model and then fed into this model. This model applies a list of layers
    ...
    def predict(self,
        ...
        The model applies layers sequentially while each layer chooses the graph
        that they operate on. For example, a layer can choose the i-th graph,
        ...
        outputs the updated vertex_features. Then the next layer takes the
        vertex_features and also chooses a graph to further update the features.
        ...
        with slim.arg_scope([slim.batch_norm], is_training=is_training), \
            slim.arg_scope([slim.fully_connected],
                ...
                with tf.compat.v1.variable_scope(predictor_config['scope'],
    ...
    def loss(self, logits, labels, pred_box, gt_box, valid_box,
        ...
        Args:
            ...
            cls_loss_kwargs: dict, keyword args to the classification loss.
            ...
            cls_loss_weight: scalar, weight on the classification loss.
        ...
        with tf.control_dependencies([tf.compat.v1.assert_equal(tf.math.is_nan(loc_loss), False)]):
